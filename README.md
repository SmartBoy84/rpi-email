...
This new setup scored 8.4/10 in the mail-test, unfortunately the mark deduction is due to an incorrent ptr (only my isp can set the ptr record)  
Unfortunately, an invalid ptr reocrd means I can't send mail to gmail either :(
